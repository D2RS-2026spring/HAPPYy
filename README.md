...
- 小组名称：
- 小组成员:
  刘卓益（2025303110003）[@hzauShixin](https://github.com/hzauShixin)
  李俊杰（）
  朱烁龙（）
  高心灵（）
  章靖（）
...
- 图片具体内容为： (b-c) 按组和个体小鼠在门水平上绘制的条形图。条形代表平均相对丰度。(d) 第0天和第28天的细菌Shannon α多样性。 (e) 按日常和饮食治疗划分的 Bray-Curtis β细菌多样性。 (f) 肠杆菌 cfu 计数。
## 具体分工与文件
- **Fig.1b 复现（刘卓益）：**
代码文件：re包中的intro.qmd
